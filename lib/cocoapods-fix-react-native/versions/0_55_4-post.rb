...
same_repo_node_modules = File.directory?('react-native')
previous_repo_node_modules = File.directory?('../react-native')

# Find out where the files could be rooted
$root = 'Pods/React'
if dev_pods_react
  $root = 'react-native' if same_repo_node_modules
  $root = '../react-native' if previous_repo_node_modules
end
